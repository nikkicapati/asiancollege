...
function dazzling_social(){
    ...
    foreach ( $services as $service ) :
        ...
        if ($active[$service]) { echo '<li><a href="'.$active[$service].'" class="social-icon '. $service .'" title="'. __('Follow us on ','dazzling').$service.'">';
if($service == "facebook" || $service == "twitter" || $service == "googleplus"){
  
  if($service == "googleplus"){
    $service = 'google-plus-square';
  } else{
    $service = $service.'-square';
  }
}
echo '<i class="social_icon fa fa-'.$service.'"></i></a></li>';}
...
if ( ! function_exists( 'dazzling_first_layer' ) ) :
/**
 * First Layer
 */
function dazzling_first_layer() {
  echo '
  <div class="clearfix">&nbsp;</div>
  <div class="first_layer container-fluid" style="border:1px solid red;">
          <div class="first_image row">
            <div style="position:relative;height:30.9vw;">
              <div class="big_ac">
                <img src="wp-content/themes/dazzling/inc/admin/images/ac.jpg" />
              </div>
              <div class="welcome">
                <p>Welcome to</p>
              </div>
              <div class="col-md-4" style="margin-top: 9.3%; margin-left: 55%;width:9.5%;">
                <img src="wp-content/themes/dazzling/inc/admin/images/emblem.jpg" />
              </div>
              <div class="col-md-4" style="margin-top:9.3%;padding:0;">
                <img src="wp-content/themes/dazzling/inc/admin/images/logo_2.jpg"/>
                <div class="for_subs">
                  <p class="subs">Developing Leaders in IT and Management</p>
                </div>
                <div class="first_blurb">
                  <p>Asian College of Science and Technology (Asian College) is a CHED and TESDA-accredited tertiary educational institution 
                  dedicated to the success of its graduates in their chosen field of study. With campuses in Quezon City and Dumaguete, Negros Oriental,
                  Asian College has produced thousands high quality graduates with globally relevant skills and knowledge for the past 40 years.</p>
                </div>
              </div>
            </div> 
            <div data-toggle="collapse" data-target="#layer_1" aria-expanded="false" aria-controls="collapseExample" style="cursor:pointer;">
              <img style="width:8%;display: block; float:right; margin-right:46%;margin-top:-2vw;padding-bottom:2vw" src="wp-content/themes/dazzling/inc/admin/images/arrow_down1.jpg" />
            </div>           
          </div>
        </div>
          <div class="collapse" id="layer_1">
            <div class="well">
              Some text.
            </div>
          </div>';
...
if ( ! function_exists( 'dazzling_second_layer' ) ) :
/**
 * Second Layer
 */
function dazzling_second_layer() {
  echo '<div class="second_layer container-fluid">
          <div class="row">
            <div class="old_acsat col-md-4">
              <img class="img_acsat" src="wp-content/themes/dazzling/inc/admin/images/acsat.jpg">
            </div>
            <div class="for_square_logo col-md-4"> 
              <div class="for_arrow">
                <img class="img_arrow" src="wp-content/themes/dazzling/inc/admin/images/arrow_white.jpg">
              </div>
              <div class="square_position">
                <img class="square_logo" src="wp-content/themes/dazzling/inc/admin/images/ac_logo_square.jpg" />
              </div>
            </div>
            <div class="col-md-6 third_row">
              <div class="for_second_text">
                <p class="second_text">From ACSAT to Asian College</p>
              </div>
              <div class="under_second_text">
              <p>Recently, the board of trustees decided to change the short name of the school to “Asian College” in time for its 40th anniversary. 
              The new name ushers in a new era for the school as it strives to continuously evolve with the changing times, not merely catering to science and technology courses, but also focused on developing professionals in the fields of business and management. </p>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-md-offset-4" data-toggle="collapse" data-target="#layer_2" aria-expanded="false" aria-controls="collapseExample">
          <img style="width: 30%; display: block; padding-bottom: 2vw;margin:0 auto;cursor:pointer;" src="wp-content/themes/dazzling/inc/admin/images/arrow_down2.jpg" />
          </div>
        </div>
        <div class="collapse" id="layer_2">
          <div class="well">
            Some text.
          </div>
        </div>';
